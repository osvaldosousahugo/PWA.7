...
const app = (() => {
// fungsi ini akan menampilkan bendera dari tiap negara yang ada, dimana fungsi dari
//code akan membaca nama negara dan bendera dari tiap negara melalui fungsi //
...
// fungsi code promise ini membaca nama negara yang di minta ,jika benar 
//akan di tampilkan ,jika tidak code akan melewati ,tampilan eroor//
...
//mengambil nama negara berdasarkan negara //
//jika bukan tampilan error akan muncul//
...
//jika benar nama negara yang di ketik ,muncul jika tidak melewati//
  function allFlags(promiseList) {
    return Promise.all(promiseList)
    .catch(returnFalse);
  }
// membaca nama code yang di proses //
  const promises = [
    getImageName('Spain'),
    getImageName('Chile'),
    getImageName('Peru')
